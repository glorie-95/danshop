  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <figure>
          <img class="js-modal-product-cover product-cover-modal"  src="{$product.cover.large.url}" alt="{$product.cover.legend}" title="{$product.cover.legend}" itemprop="image">
        ...
        <aside id="thumbnails" class="thumbnails product-images product-images-{$product.id_product} text-sm-center">
