...
ap_list_functions.push(function(){
    //THANHNT: fix safari window
    $('#{$carouselName|escape:'html':'UTF-8'}').parent().closest('.ApProductCarousel').addClass('loading');
	...
	$('#{$carouselName|escape:'html':'UTF-8'}').imagesLoaded( function() {
        ...
        function OwlLoaded(el){
            ...
            //THANHNT: fix safari window
            el.parent().closest('.ApProductCarousel').removeClass('loading');
        };
    });
});
</script>