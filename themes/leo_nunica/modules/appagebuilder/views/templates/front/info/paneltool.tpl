					...
					<div class="group-input row layout">
						...
						<div class="col-sm-12">
							{foreach $list_productdetail_layout as $list_productdetail_layout_item}								
								<a class="product-detail-demo{if isset($product.productLayout) && $product.productLayout != '' && $product.productLayout == $list_productdetail_layout_item['plist_key']} active{/if}" data-product-detail-key={$list_productdetail_layout_item['plist_key']} href="{$list_productdetail_layout_item['product_layout_link']}">{$list_productdetail_layout_item['name']}</a>
							{/foreach}
						</div>
					</div>
				</div>
