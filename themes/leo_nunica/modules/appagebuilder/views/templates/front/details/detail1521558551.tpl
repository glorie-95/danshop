...
<section id="main" class="product-detail content-center product-image-thumbs no-thumbs" itemscope itemtype="https://schema.org/Product">
  <meta itemprop="url" content="{$product.url}"><div class="row"><div class="offset-lg-1 offset-xl-1 col-xl-10 col-lg-10 col-md-12 col-sm-12 col-xs-12 col-sp-12">
