...
<section class="special-products clearfix m-t-3 block">
  	<h2 class="h2 products-section-title title_block">{l s='On sale' d='Shop.Theme.Global'}</h2>
  	<div class="block_content">
	  	<div class="products">
	    	{include file='catalog/_partials/miniatures/leo_col_products.tpl' products=$products}
	  	</div>
	  	<a href="{$allSpecialProductsLink}" class="all-product-link float-xs-left btn btn-outline">
