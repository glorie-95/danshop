...
<div id="leo_search_block_top" class="block exclusive{if $en_search_by_cat} search-by-category{/if}">
	<a href="javascript:void(0)" class="icon-open-search" title="{l s='Search' mod='leoproductsearch'}">
	    <i class="icon-search fa fa-search"></i>
	</a>
	<div class="box-title">
		<h4 class="title_block">{l s='Search product' d='Shop.Theme.Global'}</h4>
		<p>{l s='Search for products you are interested' d='Shop.Theme.Global'}</p>
	</div>
