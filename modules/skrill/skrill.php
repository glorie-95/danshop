...
class Skrill extends PaymentModule
{
    ...
    public function uninstall()
    {
        if (!Configuration::deleteByName('SKRILL_GENERAL_MERCHANTID')
            ...
            || !Configuration::deleteByName('SKRILL_BTC_ACTIVE')

            || !Configuration::deleteByName('SKRILL_WLT_MODE')
            || !Configuration::deleteByName('SKRILL_PSC_MODE')
            || !Configuration::deleteByName('SKRILL_PCH_MODE')
            ...
            || !Configuration::deleteByName('SKRILL_BTC_MODE')
    ...
    private function getEnabledPayments()
    {
        ...
        foreach ($supportedPayments as $paymentType) {
            ...
            if ($paymentType == 'FLEXIBLE') {
                ...
                $isShowSeparately = Configuration::get('SKRILL_'.$paymentType.'_MODE');
            }
    ...
    */
        ...
        switch ($paymentMethod) {
            ...
            case 'SKRILL_FRONTEND_PM_ACC':
                if ($this->l('SKRILL_FRONTEND_PM_ACC') == "SKRILL_FRONTEND_PM_ACC") {
                    $paymentLocale = "Credit Card / Visa, Mastercard, AMEX";
                } else {
            ...
            case 'SKRILL_FRONTEND_PM_AUP':
                ...
                break;
            case 'SKRILL_FRONTEND_PM_BTC':
                if ($this->l('SKRILL_FRONTEND_PM_BTC') == "SKRILL_FRONTEND_PM_BTC") {
                    $paymentLocale = "Bitcoin";
                } else {
                    $paymentLocale = $this->l('SKRILL_FRONTEND_PM_BTC');
                }
                break;
            default:
                if ($this->l('SKRILL_FRONTEND_PM_FLEXIBLE') == "SKRILL_FRONTEND_PM_FLEXIBLE") {
    ...
    private function getBackendPaymentLocale($paymentMethod)
    {
        switch ($paymentMethod) {
            ...
            case 'SKRILL_BACKEND_AB_AOB_BANCOLOMBIA':
                ...
                break;
            case 'SKRILL_BACKEND_PM_BTC':
                if ($this->l('SKRILL_BACKEND_PM_BTC') == "SKRILL_BACKEND_PM_BTC") {
                    $paymentLocale = "Bitcoin";
                } else {
                    $paymentLocale = $this->l('SKRILL_BACKEND_PM_BTC');
                }
                break;
            default:
    ...
    protected function getPaymentConfigurationLocale()
    {
        ...
        $locale['pch']['tooltips'] = 'Austria, Croatia, Hungary, Italy, Malta,
        ...
        $locale['amx']['tooltips'] = 'All Countries (excluding United States Of America)';
        ...
        $locale['btc']['tooltips'] = "All except for Cuba, Sudan, Syria, North Korea, Iran,
