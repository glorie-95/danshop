...
class LeoProductSearch extends Module
{
    ...
    public function postProcess()
    {
        ...
        if (((bool) Tools::isSubmit('submitLeoproductsearchConfig')) == true) {
			...
			else if(!Validate::isUnsignedInt(Tools::getValue('LEOPRODUCTSEARCH_NUMPRO_DISPLAY')))
			{
...
//            $this->context->smarty->assign('errors', $this->errors);
    ...
    public function hookHeader($params)
    {
        if (Configuration::get('LEOPRODUCTSEARCH_ENABLE')) {
			...
			Media::addJsDef(array(
				...
				'txt_not_found' => $this->l('No products found'),
			...
			//DONGND::
			// Media::addJsDef(array('ajaxsearch' => Configuration::get('LEOPRODUCTSEARCH_ENABLE_AJAXSEARCH')));
    ...
    {
        if (Configuration::get('LEOPRODUCTSEARCH_ENABLE')) {
            if (Tools::getValue('search_query') || !$this->isCached('module:leoproductsearch/leosearch.tpl', $this->getCacheId())) {
			...
			return $this->fetch('module:leoproductsearch/leosearch.tpl', Tools::getValue('search_query') ? null : $this->getCacheId());
        }
    }
    ...
    public function hookTop($params)
    {
        ...
        if (Configuration::get('LEOPRODUCTSEARCH_ENABLE')) {
            if (Tools::getValue('search_query') || !$this->isCached('module:leoproductsearch/leosearch_top.tpl', $this->getCacheId())) {
                $this->calculHookCommon($params);
                $selectedCateName = '';
			...
			return $this->fetch('module:leoproductsearch/leosearch_top.tpl', Tools::getValue('search_query') ? null : $this->getCacheId());
        }
    }
