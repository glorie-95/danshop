...
$context["action"], "type", array(), "any", true, true) && ($this->getAttribute($context["action"], "type", array()) == "button"))) {
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Helpers/bootstrap_popup.html.twig", "/var/www/html/danshop/src/PrestaShopBundle/Resources/views/Admin/Helpers/bootstrap_popup.html.twig");
    }
}
